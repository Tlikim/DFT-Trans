...
from model import BertForSequenceClassification, RobertaForSequenceClassification, HyperMixForSequenceClassification
# from pytorch_pretrained_bert.tokenization import BertTokenizer
# from transformers import BertTokenizer, BertConfig, AlbertConfig, AlbertTokenizer, RobertaConfig, RobertaTokenizer, BertForSequenceClassification, RobertaForSequenceClassification, AlbertForSequenceClassification
from transformers import AlbertTokenizerFast, BertTokenizer, AlbertForSequenceClassification, AlbertConfig, BertConfig#,  BertForSequenceClassification
